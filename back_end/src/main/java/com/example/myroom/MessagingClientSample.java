...
//	public static void main(String[] args) throws IOException, InterruptedException, IotHubException {
//		//SpringApplication.run(MyRoomApplication.class, args);
//
//
//		  final IotHubServiceClientProtocol protocol =
//				IotHubServiceClientProtocol.HTTPS;
//
//		final String connectionString = "HostName=MarHeaven.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=wfOXBE5kSuVrhp2G5wM588sIFzBDFIQinAIoTNDTZTg=";
...
{
	private static final String connectionString = "HostName=MarHeaven.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=wfOXBE5kSuVrhp2G5wM588sIFzBDFIQinAIoTNDTZTg=";
	...
	public static void main(String[] args) throws InterruptedException, IOException, IotHubException
	{
		...
		try
		{
			...
			while (messageCount < NUMBER_OF_MESSAGES_TO_SEND)
			{
				...
				Message messageToSend = new Message("DIT CON ME CHUNG MAY");
